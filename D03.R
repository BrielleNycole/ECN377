...
## the two slopes:
b1 <- -9.8        # slope on price
b2 <- 0.03        # slope on income 
## price up $1, income held fixed  ->  change in quantity?
b1*1
## income down $100, price held fixed  ->  change in quantity?
b2*(-100)
...
## ================= PROBLEMS (your turn) =========================
pct_chg <- 25-20/20*100   # (a) percent change from $20 to $25
## (b) interest rate 3% -> 5%: percentage-POINT change = ____ ; percent change = ___
5-3
5-3/3*100
